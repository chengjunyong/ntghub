    ...
    <form method="post" action="#">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <input type="number" name="card_id" class="form-control" step="1" placeholder="Card Serial Number" required/>
        </div>
        <div class="col-md-6">
          <label>Card Code (Scan Member Card)</label><br/>
          <input type="text" name="card_code" class="form-control" placeholder="Please use card reader to scan customer member card."/>
        </div>
        <div class="col-md-6">
          <label>Name</label><br/>
